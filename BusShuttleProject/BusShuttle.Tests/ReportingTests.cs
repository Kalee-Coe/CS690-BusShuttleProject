...
public class ReportTests
{
    ...
    [Fact]
    public void Test_BusiestStop_Just2stops()
    {
    ...
    public void Test_FindBusiestStop_Just2stops_MoreData() {
        sampleData.Add(new PassengerData(4, new Stop ("MyStop"),new Loop("myLoop"),new Driver("My Driver")));
        sampleData.Add(new PassengerData(5, new Stop ("MyStop2"),new Loop("myLoop2"),new Driver("My Driver2")));
        sampleData.Add(new PassengerData(2, new Stop ("MyStop"),new Loop("myLoop"),new Driver("My Driver")));
